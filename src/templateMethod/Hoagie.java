...
/**
 * A Template Method Pattern contains a method that provides the steps of the
 * algorithm. It allows subclasses to override some of the methods
 */
public abstract class Hoagie {
     ...
     * Declare this method final to keep subclasses from changin the algorithm
     */
